...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setMessage(isLogin ? 
                (stayLoggedIn ? "Succesvol ingelogd! Je blijft 5 dagen ingelogd." : "Succesvol ingelogd!") 
                : "Account aangemaakt!"
            );
            setIsSuccess(true);
            ...
            <div className={styles.authWrapper}>
                <div className="card">
                    ...
                    <form onSubmit={handleSubmit} className={styles.formStack}>
                        {!isLogin && (
                            <div>
                                <label className="label-text" htmlFor="name">Naam</label>
                                <input 
                                    type="text" 
                                    id="name" 
                                    name="name" 
                        ...
                        {message && (
                            <MessageDisplay message={{ type: isSuccess ? "success" : "error", text: message }} />
                        )}

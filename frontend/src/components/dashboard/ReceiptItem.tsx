...
export function ReceiptItemComponent({ item, index, updateItem, removeItem, categories = [] }: ReceiptItemProps) {
    ...
    <div className={styles.itemCard}>
      <div className={styles.itemFieldsGrid}>
        ...
        <div className={styles.itemRemoveBtn}>
          <button onClick={() => removeItem(index)} className={`btn btn-danger ${componentStyles.removeItemButton}`}>
            ×
          </button>
        </div>
      </div>

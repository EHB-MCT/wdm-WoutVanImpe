...
export function EnhancedLoadingStates({ 
  ...
  const getCurrentStepInfo = () => {
    return PROCESSING_STEPS.find(step => step.id === currentStep) || null;
  };
  ...
  return (
    <div className={classNames(styles.loadingContainer, styles.enhancedLoading)}>
      ...
      <div className={styles.loadingHeader}>
        ...
        {currentStepInfo && currentStep !== "error" && currentStep !== "success" && (
        ...
        {PROCESSING_STEPS.slice(1, 5).map((step, index) => {
          ...
          return (
            <div key={step.id} className={classNames(styles.stepItem, getStepClassName(status))}>
              ...
              {index < 3 && (
                <div className={classNames(styles.stepConnector, {
